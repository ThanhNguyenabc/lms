...
function Course_Class_ActivityTest(data, state, source)
{
 ...
 if(User_Role() == "student" && (results.length > 1 || state == "post" || (results.length == 1 && results[0].mode != "testing"))) Document_Element_Disable(action, "style-disabled"); 
 ...
 if(User_Role() == "student" && (results.length == 0 || (results.length == 1 && results[0].mode == "testing")) && state == "pre") Document_Element_Disable(action, "style-disabled"); 
