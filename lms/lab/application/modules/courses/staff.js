...
function Courses_Staff_Display()
{
 ...
 {     
  ...
  else
  {
   ...
   // HIDE LOCAL TEACHER / NATIVE TEACHER WHEN TEACHER CONFIG IS ALL NATIVE / ALL LOCAL
   var teacher_config = Safe_Get(course, ["teacher_config"], false);
   if((teacher_config == "all local" && place == "teacher_id") || (teacher_config == "all native" && place == "local_id")) element.style.display = "none";
  }
